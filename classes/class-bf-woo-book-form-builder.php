...
class bf_woo_booking_builder {
	...
	public function buddyforms_bookeable_product_default_options($form_fields,$product_type_default,$field_id){
        ...
        $element_min_duration = new Element_Number( '<b>' . __( 'Minimum duration: ', 'buddyforms' ) . ' </b>', "buddyforms_options[form_fields][" . $field_id . "][wc_booking_min_duration]",
            array(
        ...
        $element_max_duration = new Element_Number( '<b>' . __( 'Maximum duration: ', 'buddyforms' ) . ' </b>', "buddyforms_options[form_fields][" . $field_id . "][wc_booking_max_duration]",
            array(
        ...
        $element_enable_range_picker = new Element_Checkbox( '<b>' . __( 'Enable Calendar Range Picker? ', 'buddyforms' ) . ' </b>', "buddyforms_options[form_fields][" . $field_id . "][wc_booking_enable_range_picker]", array("yes" => esc_html("Lets the user select a start and end date on the calendar - duration will be calculated automatically."  ) ),
            array(
        ...
        $element_calendar_display_mode = new Element_Select( '<b>' . __( 'Calendar display mode ', 'buddyforms' ) . '</b>',
        ...
        $element_requires_confirmation = new Element_Checkbox( '<b>' . __( 'Requires confirmation?', 'buddyforms' ) . ' </b>', "buddyforms_options[form_fields][" . $field_id . "][wc_booking_requires_confirmation]", array("yes" => esc_html("Check this box if the booking requires admin approval/confirmation. Payment will not be taken during checkout."  ) ),
            array(
        ...
        //Can be cancelled
        $element_can_be_cancelled = new Element_Checkbox( '<b>' . __( 'Can be cancelled? ', 'buddyforms' ) . ' </b>', "buddyforms_options[form_fields][" . $field_id . "][wc_booking_user_can_cancel]", array("yes" => esc_html("Check this box if the booking can be cancelled by the customer after it has been purchased. A refund will not be sent automatically."  ) ),
            array(
        ...
        $element_cancel_limit =  new Element_Number( '<b>' . __( 'Cancel Limit ', 'buddyforms' ) . ' </b>', "buddyforms_options[form_fields][" . $field_id . "][wc_booking_cancel_limit]",
            array(
        ...
        $element_cancel_limit_unit = new Element_Select( '<b>' . __( 'Cancel Limit Unit: ', 'buddyforms' ) . '</b>',
